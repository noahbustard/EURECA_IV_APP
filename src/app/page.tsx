    ...
    <div className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
      ...
      <div className="mx-auto flex h-[510px] w-[360px] items-start justify-center gap-6 pt-2">
        <div className="relative h-[458px] w-[120px]">
          ...
          <div className="absolute left-[38px] top-[352px] h-[2px] w-[28px] bg-zinc-700" />
          <div className="absolute left-[38px] top-[352px] h-14 w-[2px] bg-zinc-700" />
          <div className="absolute left-[64px] top-[352px] h-14 w-[2px] bg-zinc-700" />
          <div className="absolute left-[38px] top-[406px] h-[2px] w-[28px] bg-zinc-700" />
        </div>
