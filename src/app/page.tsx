    ...
    <div className="space-y-4 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
      ...
      <div className="mx-auto flex h-[510px] w-[360px] items-start justify-center gap-6 pt-2">
        <div className="relative h-[390px] w-[120px]">
          ...
          <div className="absolute left-[8px] top-[332px] h-10 w-[4px] origin-top -rotate-[52deg] bg-zinc-700" />
          <div className="absolute right-[8px] top-[332px] h-10 w-[4px] origin-top rotate-[52deg] bg-zinc-700" />
        </div>
